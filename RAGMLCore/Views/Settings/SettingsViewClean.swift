...
struct AboutScreen: View {
    var body: some View {
        List {
            ...
            Section {
                Link(destination: URL(string: "https://github.com/Gunnarguy/RAGMLCore")!) {
            ...
            Section {
                Text(
                    "RAGMLCore is a privacy-first RAG (Retrieval-Augmented Generation) app for iOS. All processing happens on-device or through Apple's Private Cloud Compute."
                )
                .font(.callout)
                .foregroundColor(.secondary)
            }
